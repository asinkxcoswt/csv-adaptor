...
import com.opencsv.bean.exceptions.LineNotParsableException;
...
//                e.printStackTrace();
//                LineNotParsableException csvException = new LineNotParsableException(ResourceBundle.getBundle(ICSVParser.DEFAULT_BUNDLE_NAME, errorLocale).getString("parsing.error"));
//                csvException.setLine(line);
//                OpencsvUtils.handleException(csvException, lineProcessed, exceptionHandler, thrownExceptionsQueue);
